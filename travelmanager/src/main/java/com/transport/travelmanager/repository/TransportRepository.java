...
public class TransportRepository {
	...
	public Transport createNewTransport(Long destinyId,Long vehicleId,Integer capacity ,Date dateTimeTraveStart) {
		...
		String sql = "INSERT INTO TRANSPORTS (ID, DATE_TIME_TRAVEL_START, SEATS, DESTINY_ID, VEHICLE_ID) VALUES (?,?,?,?,?)";
	...
	public Transport findById(Long transportId) {
		String sql = "SELECT t.id as T_ID, t.date_time_travel_start as T_DATE_TIME_TRAVEL_START, t.seats as T_SEATS, t.destiny_id as T_DESTINY_ID, \n" + 
